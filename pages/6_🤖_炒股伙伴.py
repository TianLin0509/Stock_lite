...
st.set_page_config(page_title="🤖 炒股伙伴", page_icon="🤖", layout="wide")
...
# 渲染炒股伙伴页面
from ui.tabs.companion import render_companion_tab
render_companion_tab(client, cfg, selected_model)
